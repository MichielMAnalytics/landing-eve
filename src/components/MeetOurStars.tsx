    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-0 md:gap-0 mt-24">
        ...
        <div className="relative z-10 w-full md:w-[28%] max-w-sm -rotate-3 md:mt-12 md:mb-0 mb-8 md:mr-[-24px] group transition-transform duration-300">
          <div className="rounded-2xl p-8 flex flex-col items-center bg-gradient-to-br from-[#0EA5E9] to-[#04062D] border-2 border-[rgba(216,217,236,0.5)] shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <button className="bg-[#fff]/10 hover:bg-[#fff]/20 text-white px-6 py-2.5 rounded-lg font-inter font-semibold text-base border border-[rgba(216,217,236,0.2)] transition-all duration-200 w-full mt-auto">Learn more</button>
          </div>
        </div>
        {/* Center Card - Alex */}
        <div className="relative z-20 w-full md:w-[36%] max-w-lg scale-105 md:scale-110 shadow-2xl md:-mt-8 md:mx-0 mx-auto group transition-transform duration-300">
          <div className="rounded-2xl p-10 flex flex-col items-center bg-gradient-to-br from-[#6E3ADE] to-[#04062D] border-2 border-[rgba(216,217,236,0.7)] shadow-2xl hover:shadow-3xl transition-all duration-300">
            ...
            <button className="bg-[#fff]/10 hover:bg-[#fff]/20 text-white px-8 py-3 rounded-lg font-inter font-semibold text-xl border border-[rgba(216,217,236,0.2)] transition-all duration-200 w-full mt-auto">Learn more</button>
          </div>
        </div>
        {/* Right Card - Nova */}
        <div className="relative z-10 w-full md:w-[28%] max-w-sm rotate-3 md:mb-12 md:mt-0 mt-8 md:ml-[-24px] group transition-transform duration-300">
          <div className="rounded-2xl p-8 flex flex-col items-center bg-gradient-to-br from-[#FFD600] to-[#04062D] border-2 border-[rgba(216,217,236,0.5)] shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="relative w-36 h-36 md:w-44 md:h-44 mb-6">
              <img 
                src="/Nova.png"
                alt="Nova Agent"
