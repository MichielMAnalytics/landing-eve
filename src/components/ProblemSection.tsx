  ...
  return (
    <section className="py-16 sm:py-24 bg-black">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-8 flex flex-col items-center">
        <h2 className="text-2xl sm:text-4xl md:text-5xl font-comfortaa font-bold text-[#FFFFFF] mb-10 text-center leading-[1.2] max-w-3xl">
          Let your AI employees do the work. Automate everything.
        </h2>
