...
const AgentCard: React.FC<AgentCardProps> = ({
  ...
  return (
    <div
      className={`max-w-7xl mx-auto px-4 sm:px-8 mb-24 ${className}`}
      style={style}
    >
      <div
        className={`bg-[#04062D] border border-[${colors.primary}] backdrop-blur-sm rounded-[32px] p-12 md:p-16 flex flex-col md:flex-row items-center gap-12`}
      >
        {/* Content Side */}
